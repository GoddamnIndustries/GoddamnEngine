...
GD_NAMESPACE_BEGIN
	...
	//! Basic SIMD register math generic implementation. Do not use directly.
	//! @tparam SIMDRegisterType Type of a SIMD register.
	template<typename SIMDRegisterType>
	class SIMDGeneric
	{
	public:
		//! Type this CPU uses as a SIMD register.
...
#if !GD_DOCUMENTATION
#	if GD_PLATFORM_API_MICROSOFT && (!defined(__cplusplus_cli)) && 0 
...
GD_NAMESPACE_BEGIN
	...
	//! SIMD register math implementation.
