...
/*!
 * @file GoddamnEngine/Core/System/Graphics/GraphicsDirect2D/Graphics2DDirect2DRectRenderer.cpp
...
GD_NAMESPACE_BEGIN
	...
	GDAPI IGraphics2DDirect2DRectRenderer::IGraphics2DDirect2DRectRenderer(IGraphics2DRectRendererCreationInfo const* const gfxRectRendererCreationInfo)
		...
		, D2DBitmap(static_cast<IGraphics2DDirect2DBitmap const*>(gfxRectRendererCreationInfo->RectBitmap))
	{
	}
