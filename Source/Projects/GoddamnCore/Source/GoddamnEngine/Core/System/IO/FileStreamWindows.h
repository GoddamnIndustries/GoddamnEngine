...
/*! 
 * @file GoddamnEngine/Core/System/OP/FileStream.h
 * File contains C-standard IO file stream interfaces.
 */
#pragma once
#if !defined(GD_INSIDE_FILESTREAM_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Core/System/IO/FileStream.h> instead.
#endif	// if !defined(GD_INSIDE_FILESTREAM_H)

#include <GoddamnEngine/Core/System/IO/FileStreamStandard.h>
