#include <GoddamnEngine/Engine/Resource/Texture2D/Texture2DResource.h>
...
GD_NAMESPACE_BEGIN
	...
	{
		Vector<UInt8> texture2DData(resourceLoader->GetResourceDataSize());
		resourceLoader->Read(&texture2DData[0], texture2DData.GetSize());
