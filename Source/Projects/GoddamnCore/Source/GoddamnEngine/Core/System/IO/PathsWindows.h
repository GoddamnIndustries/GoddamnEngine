...
/*! 
 * @file GoddamnEngine/Core/System/IO/PathsWindows.h
 * File contains Windows paths helpers interface.
 */
#pragma once
#if !defined(GD_INSIDE_PATHS_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Core/System/IO/Paths.h> instead.
