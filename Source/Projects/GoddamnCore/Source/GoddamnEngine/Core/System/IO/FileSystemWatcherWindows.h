...
/*! 
 * @file GoddamnEngine/Core/System/IO/FileSystemWatcherWindows.h
 * File contains Windows file system watcher interface.
 */
#pragma once
#if !defined(GD_INSIDE_FILESYSTEMWATCHER_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Core/System/IO/FileSystemWatcher.h> instead.
