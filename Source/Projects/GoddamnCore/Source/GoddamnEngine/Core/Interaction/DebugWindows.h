...
/*! 
 * @file GoddamnEngine/Core/Interaction/DebugWindows.h
 * Windows output device definitions.
 */
#pragma once
#if !defined(GD_INSIDE_OUTPUT_OUTPUTDEVICE_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Debug.h> instead.
...
GD_NAMESPACE_BEGIN
	...
	// **~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~**
	class DebugWindows final : public DebugGeneric
	{
		// ------------------------------------------------------------------------------------------
