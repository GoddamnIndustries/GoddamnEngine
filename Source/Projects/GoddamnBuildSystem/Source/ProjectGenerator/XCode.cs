...
//! @file XCode.cs
//! XCode IDE project files generator.
...
namespace GoddamnEngine.BuildSystem.ProjectGenerator.XCode
{
    ...
    internal sealed class XCodeReference
    {
        ...
        {
            return new string('0', 24 - PropertyNameHash.m_Length) + this.ReferenceName.GetHashCode().ToString("X");
        }
    ...
    public class XCodeObject
    {
        ...
        public sealed override string ToString()
        {
            ...
            foreach (FieldInfo Property in this.GetType().GetFields()) {   // Searching throw all fields inside object
                ...
                Debug.Assert(PropertyAttributes.m_Length <= 1, "Invalid XCodeProperty attribute was found");
                if (PropertyAttributes.m_Length == 1) {
