...
/*! 
 * @file GoddamnEngine/Core/IO/FileSystemWatcher.h
...
GD_NAMESPACE_BEGIN
	...
	public:
		 ...
		 * 
		 * @param handler Function that handles file system events.
		...
		{
			GD_DEBUG_VERIFY(handler != nullptr, "Null pointer handler was specified.");
			GD_DEBUG_VERIFY(notifyFilters != FileSystemWatcherNotifyFilters::None, "Empty notification filters were specified.");
...
#include GD_PLATFORM_INCLUDE(GoddamnEngine/Core/IO, FileSystemWatcher)
