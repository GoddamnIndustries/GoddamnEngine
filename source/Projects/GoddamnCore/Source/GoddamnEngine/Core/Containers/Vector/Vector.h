...
GD_NAMESPACE_BEGIN
	...
	public:
		...
		inline Vector(InitializerList<ElementType> const& InitializerList);
	...
	public /* Class API */:
		...
		GDINL PtrMutableIterator PtrEnd()       { return (this->PtrBegin() + this->Length); }
		...
		GDINL MutableIterator    End()       { return (this->Begin() + this->Length); }
		...
		inline Vector& operator= (InitializerList<ElementType> const& InitializerList);
#if (defined(__cplusplus_cli))
