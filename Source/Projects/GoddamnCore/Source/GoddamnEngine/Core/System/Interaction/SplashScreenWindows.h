...
/*!
 * @file GoddamnEngine/Core/System/Interaction/SplashScreenWindows.h
 * Windows splash screens.
 */
#pragma once
#if !defined(GD_INSIDE_SPLASHSCREEN_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Core/System/Interaction/SplashScreen.h> instead.
