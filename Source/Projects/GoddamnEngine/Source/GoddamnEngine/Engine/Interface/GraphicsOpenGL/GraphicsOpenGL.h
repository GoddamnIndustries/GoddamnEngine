...
/*!
 * @file GoddamnEngine/Engine/Interface/GraphicsOpenGL/GraphicsOpenGL.h
...
#	include GD_PLATFORM_API_INCLUDE(GoddamnEngine/Engine/Interface/GraphicsOpenGL, GraphicsOpenGL)
#else // if GD_PLATFORM_API_LIBSDL1 || GD_PLATFORM_API_LIBSDL2
#	include GD_PLATFORM_INCLUDE(GoddamnEngine/Engine/Interface/GraphicsOpenGL, GraphicsOpenGL)
...
GD_NAMESPACE_BEGIN
	...
	public:
		...
		GDAPI virtual void GfxCmd_VertexArrayBind(IGraphicsCommandList* const gfxCommandList, IGraphicsVertexArray* const gfxVertexArray) override final;
	...
	public:
		...
		GDAPI virtual void GfxCmd_PipelineBind(IGraphicsCommandList* const gfxCommandList, IGraphicsPipelineState* const gfxPipeline) override final;
	};	// uinterface IGraphicsOpenGLPipelineState
...
#if GD_IGRAPHICS_OPENGL_IMPL
	GLenum static const IGraphicsOpenGLTopologyTypesTable[IGRAPHICS_SHADER_TOPOLOGIES_COUNT] = {
	...
	GD_UNIQUE_INTERFACE_DEFINE_PARTIAL(IGraphicsOpenGLWithRenderTargets, IGraphicsOpenGL)
	{
	public:
		GDAPI virtual void GfxCmd_RenderTargetClearDepth(IGraphicsCommandList* const gfxCommandList) override final;
		GDAPI virtual void GfxCmd_RenderTargetClearColor(IGraphicsCommandList* const gfxCommandList, GeomColor const gfxClearColor) override final;
		GDAPI virtual void GfxCmd_RenderTargetRender(IGraphicsCommandList* const gfxCommandList, IGraphicsTopologyType const gfxTopology, SizeTp const gfxVerticesCount) override final;
		GDAPI virtual void GfxCmd_RenderTargetRenderIndexed(IGraphicsCommandList* const gfxCommandList, IGraphicsTopologyType const gfxTopology, SizeTp const gfxIndicesCount, IGraphicsFormatType gfxIndexType) override final;
	};	// uinterface IGraphicsOpenGLPipelineState
