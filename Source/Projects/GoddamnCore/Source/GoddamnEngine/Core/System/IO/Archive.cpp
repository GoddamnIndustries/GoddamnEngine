...
/*! 
 * @file GoddamnEngine/Core/System/IO/Archive.cpp
 * File contains archive interfaces.
 */
#include <GoddamnEngine/Core/System/IO/Archive.h>
#include <GoddamnEngine/Core/System/IO/MemoryStream.h>
...
GD_NAMESPACE_BEGIN
	...
	public:
		...
		{
			GD_DEBUG_ASSERT(archiveInputStream != nullptr, "Null pointer input stream specified.");
			GD_DEBUG_ASSERT(archiveInputStream->IsValid(), "Invalid input stream specified.");
	...
	public:
		...
		{
			GD_DEBUG_ASSERT(IsValid(), "Reading from the invalid archive.");
