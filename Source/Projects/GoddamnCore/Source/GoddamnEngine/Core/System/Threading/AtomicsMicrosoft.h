...
/*!
 * @file GoddamnEngine/Core/System/Threading/AtomicsMicrosoft.h
 * @note This file should be never directly included, please consider using <GoddamnEngine/Core/System/Threading/Atomics.h> instead.
 * File contains Microsoft Atomics implementation.
 */
#pragma once
#if !defined(GD_INSIDE_ATOMICS_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Core/System/Threading/Atomics.h> instead.
