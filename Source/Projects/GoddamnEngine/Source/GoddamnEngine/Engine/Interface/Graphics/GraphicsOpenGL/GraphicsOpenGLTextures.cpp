...
/*!
 * @file GoddamnEngine/Engine/Interface/Graphics/GraphicsOpenGL/GraphicsOpenGLTextures.cpp
...
#include <GoddamnEngine/Engine/Interface/Graphics/GraphicsOpenGL/GraphicsOpenGLFormat.h>
...
GD_NAMESPACE_BEGIN
	...
	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsOpenGLShaderResourceView);

	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Sampler state objects.
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsOpenGLSamplerState);
	...
	GDAPI IGraphicsOpenGLSamplerState::IGraphicsOpenGLSamplerState(IGraphicsSamplerStateCreationInfo const* const gfxSamplerStateCreationInfo)
		: IGraphicsSamplerState(gfxSamplerStateCreationInfo), GLSamplerStateID(0)
	{
		glGenSamplers(1, &GLSamplerStateID);

		// Setting up the wrap modes..
		glSamplerParameteri(GLSamplerStateID, GL_TEXTURE_WRAP_S, IGraphicsOpenGLTextureAddressModesTable[gfxSamplerStateCreationInfo->SamplerAddressModeU]);
		glSamplerParameteri(GLSamplerStateID, GL_TEXTURE_WRAP_T, IGraphicsOpenGLTextureAddressModesTable[gfxSamplerStateCreationInfo->SamplerAddressModeV]);
		glSamplerParameteri(GLSamplerStateID, GL_TEXTURE_WRAP_R, IGraphicsOpenGLTextureAddressModesTable[gfxSamplerStateCreationInfo->SamplerAddressModeW]);
		...
		if (GLEW_EXT_texture_filter_anisotropic && gfxSamplerStateCreationInfo->SamplerMaxAnisotropy != 0)
		{
			...
			glSamplerParameteri(GLSamplerStateID, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
			glSamplerParameteri(GLSamplerStateID, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
			...
			glSamplerParameterf(GLSamplerStateID, GL_TEXTURE_MAX_ANISOTROPY_EXT
		...
		else
		{
			...
			glSamplerParameteri(GLSamplerStateID, GL_TEXTURE_MIN_FILTER, IGraphicsOpenGLTextureMinFiltersTable[gfxSamplerStateCreationInfo->SamplerMinFilter]);
			glSamplerParameteri(GLSamplerStateID, GL_TEXTURE_MAG_FILTER, IGraphicsOpenGLTextureMagFiltersTable[gfxSamplerStateCreationInfo->SamplerMagFilter]);
		}

		// Setting up the level-of-details-parameters and border color..
		glSamplerParameterfv(GLSamplerStateID, GL_TEXTURE_BORDER_COLOR, gfxSamplerStateCreationInfo->SamplerBorderColor.GetData());
		glSamplerParameterf(GLSamplerStateID, GL_TEXTURE_MIN_LOD, gfxSamplerStateCreationInfo->SamplerLODMinClamp);
		glSamplerParameterf(GLSamplerStateID, GL_TEXTURE_MAX_LOD, gfxSamplerStateCreationInfo->SamplerLODMaxClamp != 0.0f
	...
	{
		glDeleteSamplers(1, &GLSamplerStateID);
	}
	...
	GDAPI IGraphicsOpenGLShaderResourceView::IGraphicsOpenGLShaderResourceView(IGraphicsResourceType const gfxResourceType)
		: GLShaderResourceID(0), GLShaderResourceType(IGraphicsOpenGLResourceTypesTable[gfxResourceType])
	{
	}
	...
	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsOpenGLTexture2D);
	...
	GDAPI IGraphicsOpenGLTexture2D::IGraphicsOpenGLTexture2D(IGraphicsTexture2DCreationInfo const* const gfxTexture2DCreationInfo
		...
		: IGraphicsTexture2D(gfxTexture2DCreationInfo), GLTexture2DID(0), GLShaderResourceView(nullptr)
	{
		glGenTextures(1, &GLTexture2DID);
		Imm_UpdateData(gfxTexture2DInitialData);

		GLShaderResourceView = GD_NEW(IGraphicsOpenGLShaderResourceView, IGRAPHICS_RESOURCE_TYPE_TEXTURE_2D);
		GLShaderResourceView->GLShaderResourceID = GLTexture2DID;
	}
	...
	{
		glDeleteTextures(1, &GLTexture2DID);
		...
		: IGraphicsTextureCube(gfxTextureCubeCreationInfo), GLTextureCubeID(0), GLShaderResourceView(nullptr)
	{
		...
		GLShaderResourceView = GD_NEW(IGraphicsOpenGLShaderResourceView, IGRAPHICS_RESOURCE_TYPE_TEXTURE_CUBE);
