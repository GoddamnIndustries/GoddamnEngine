...
/*!
 * @file GoddamnEngine/Core/System/Graphics/GraphicsDirect3D11/GraphicsDirect3D11Shaders.cpp
 * File contains Implementation for Direct3D11 Implementation of the graphics interface: shaders.
 */
...
GD_NAMESPACE_BEGIN
	 ...
	 */
	GDAPI IGraphicsDirect3D11VertexShader::IGraphicsDirect3D11VertexShader(IGraphicsShaderCreationInfo const* const gfxShaderCreationInfo)
	 ...
	 */
	GDAPI IResult IGraphicsDirect3D11WithVertexShaders::GfxImm_VertexShaderCreate(IGraphicsVertexShader** const gfxVertexShaderPtr
		, IGraphicsShaderCreationInfo const* const gfxShaderCreationInfo, IGraphicsVertexArrayLayout const* const gfxVertexArrayLayout)
	{
		...
		*gfxVertexShaderPtr = gd_new IGraphicsDirect3D11VertexShader(&gfxShaderCreationInfoCopy, gfxVertexArrayLayout);
		return IResult::Ok;
	}
	 ...
	 */
	GDAPI void IGraphicsDirect3D11WithVertexShaders::GfxCmd_VertexShaderBindUniformBuffers(IGraphicsCommandList* const gfxCommandList
		, IGraphicsBuffer const* const* const gfxUniformBuffers, SizeTp const gfxUniformBuffersCount)
	{
		GD_NOT_USED(gfxCommandList);
		auto const d3dConstantBuffers = reinterpret_cast<IGraphicsDirect3D11Buffer const* const*>(gfxUniformBuffers);

		Vector<ID3D11(Buffer)*> d3dConstantBuffersList(0, gfxUniformBuffersCount);
	 ...
	 */
	GDAPI void IGraphicsDirect3D11WithVertexShaders::GfxCmd_VertexShaderBindResources(IGraphicsCommandList* const gfxCommandList
		, IGraphicsShaderResourceView const* const* const gfxResources, SizeTp const gfxResourcesCount)
	{
		GD_NOT_USED(gfxCommandList);
		auto const d3dResources = reinterpret_cast<IGraphicsDirect3D11ShaderResourceView const* const*>(gfxResources);
		
		Vector<ID3D11(ShaderResourceView)*> d3dShaderResourceViewsList(0, gfxResourcesCount);
	 ...
	 */
	GDAPI void IGraphicsDirect3D11WithVertexShaders::GfxCmd_VertexShaderBindSamplers(IGraphicsCommandList* const gfxCommandList
		, IGraphicsSamplerState const* const* const gfxSamplerStates, SizeTp const gfxSamplerStatesCount)
	{
		GD_NOT_USED(gfxCommandList);
		auto const d3dSamplerStates = reinterpret_cast<IGraphicsDirect3D11SamplerState const* const*>(gfxSamplerStates);
		
		Vector<ID3D11(SamplerState)*> d3dSamplerStatesList(0, gfxSamplerStatesCount);
	...
	GDAPI IGraphicsDirect3D11PixelShader::IGraphicsDirect3D11PixelShader(IGraphicsShaderCreationInfo const* const gfxShaderCreationInfo)
	...
	GDAPI IGraphicsDirect3D11PixelShader::~IGraphicsDirect3D11PixelShader()
	{
	}
	...
	//! @returns Non-negative value if the operation succeeded.
	GDAPI IResult IGraphicsDirect3D11WithPixelShaders::GfxImm_PixelShaderCreate(IGraphicsPixelShader** const gfxPixelShaderPtr
		, IGraphicsShaderCreationInfo const* const gfxShaderCreationInfo)
	{
		...
		*gfxPixelShaderPtr = GD_NEW(IGraphicsDirect3D11PixelShader, &gfxShaderCreationInfoCopy);
		return IResult::Ok;
	}
	...
	//! @param gfxUniformBuffers Pointer to the uniform buffers list.
	//! @param gfxUniformBuffersCount Number of the uniform buffers to bind.
	GDAPI void IGraphicsDirect3D11WithPixelShaders::GfxCmd_PixelShaderBindUniformBuffers(IGraphicsCommandList* const gfxCommandList
		, IGraphicsBuffer const* const* const gfxUniformBuffers, SizeTp const gfxUniformBuffersCount)
	{
#if GD_DEBUG
		...
		GD_NOT_USED(gfxCommandList);
		auto const d3dUniformBuffers = reinterpret_cast<IGraphicsDirect3D11Buffer const* const*>(gfxUniformBuffers);
	...
	//! @param gfxResources Pointer to the resources list.
	//! @param gfxResourcesCount Number of the resources to bind.
	GDAPI void IGraphicsDirect3D11WithPixelShaders::GfxCmd_PixelShaderBindResources(IGraphicsCommandList* const gfxCommandList
		, IGraphicsShaderResourceView const* const* const gfxResources, SizeTp const gfxResourcesCount)
	{
#if GD_DEBUG
	...
	GDAPI void IGraphicsDirect3D11WithPixelShaders::GfxCmd_PixelShaderBindSamplers(IGraphicsCommandList* const gfxCommandList
		, IGraphicsSamplerState const* const* const gfxSamplerStates, SizeTp const gfxSamplerStatesCount)
	{
#if GD_DEBUG
	...
	//! @param gfxBufferCreationInfo Pointer to the buffer creation information.
	//! @param gfxBufferInitialData Initial data of the buffer. Can be null pointer for en empty buffer.
	GDAPI IGraphicsDirect3D11GeometryShader::IGraphicsDirect3D11GeometryShader(IGraphicsShaderCreationInfo const* const gfxShaderCreationInfo)
	...
	GDAPI IGraphicsDirect3D11GeometryShader::~IGraphicsDirect3D11GeometryShader()
	{
	}
	...
	//! @returns Non-negative value if the operation succeeded.
	GDAPI IResult IGraphicsDirect3D11WithGeometryShaders::GfxImm_GeometryShaderCreate(IGraphicsGeometryShader** const gfxGeometryShaderPtr
		, IGraphicsShaderCreationInfo const* const gfxShaderCreationInfo)
	{
#if GD_DEBUG
		...
		*gfxGeometryShaderPtr = GD_NEW(IGraphicsDirect3D11GeometryShader, &gfxShaderCreationInfoCopy);
		return IResult::Ok;
	}
	...
	//! @param gfxUniformBuffers Pointer to the uniform buffers list.
	//! @param gfxUniformBuffersCount Number of the uniform buffers to bind.
	GDAPI void IGraphicsDirect3D11WithGeometryShaders::GfxCmd_GeometryShaderBindUniformBuffers(IGraphicsCommandList* const gfxCommandList
		, IGraphicsBuffer const* const* const gfxUniformBuffers, SizeTp const gfxUniformBuffersCount)
	{
#if GD_DEBUG
	...
	//! @param gfxResources Pointer to the resources list.
	//! @param gfxResourcesCount Number of the resources to bind.
	GDAPI void IGraphicsDirect3D11WithGeometryShaders::GfxCmd_GeometryShaderBindResources(IGraphicsCommandList* const gfxCommandList
		, IGraphicsShaderResourceView const* const* const gfxResources, SizeTp const gfxResourcesCount)
	{
#if GD_DEBUG
	...
	//! @param gfxSamplers Pointer to the samplers list.
	//! @param gfxSamplersCount Number of the resources to bind.
	GDAPI void IGraphicsDirect3D11WithGeometryShaders::GfxCmd_GeometryShaderBindSamplers(IGraphicsCommandList* const gfxCommandList
		, IGraphicsSamplerState const* const* const gfxSamplerStates, SizeTp const gfxSamplerStatesCount)
	{
#if GD_DEBUG
