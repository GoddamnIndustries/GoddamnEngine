...
GD_NAMESPACE_BEGIN
	...
	namespace TypeTraits
	{
		...
		template<typename TType> struct RemoveConst              final { typedef TType Type; };
		template<typename TType> struct RemoveConst<TType const> final { typedef TType Type; };
...
#if (!defined(GD_DOCUMENTATION)) 
		template<typename TType> struct RemoveReference          final { typedef TType Type; };
		template<typename TType> struct RemoveReference<TType &> final { typedef TType Type; };
		template<typename TType> struct RemoveReference<TType&&> final { typedef TType Type; };
#else	// if (!defined(GD_DOCUMENTATION))
...
#if (!defined(GD_DOCUMENTATION)) 
		template<typename TType> struct RemovePointer                        final { typedef TType Type; };
		template<typename TType> struct RemovePointer<TType               *> final { typedef TType Type; };
		template<typename TType> struct RemovePointer<TType volatile      *> final { typedef TType Type; };
		template<typename TType> struct RemovePointer<TType volatile const*> final { typedef TType Type; };
		template<typename TType> struct RemovePointer<TType          const*> final { typedef TType Type; };
#else	// if (!defined(GD_DOCUMENTATION))
...
#if (!defined(GD_DOCUMENTATION)) 
		template<typename TType> struct RemoveAllModifiers final { typedef typename RemoveConst<typename RemovePointer<typename RemoveReference<TType>::Type>::Type>::Type Type; };
#else	// if (!defined(GD_DOCUMENTATION))
...
#if (!defined(GD_DOCUMENTATION))
		template<bool const TraitsValue> struct TypeTraitsBase { enum ValueType { Value = static_cast<bool>(TraitsValue) }; };
#endif	// if (!defined(GD_DOCUMENTATION))
		...
		public:
			enum ValueType { Value = (sizeof(Test(GetDummyInstance())) == sizeof(Yes)) };
#endif	// if (!defined(GD_DOCUMENTATION))
		};	// struct IsBaseType
	} // namespace TypeTraits
