...
/*!
* @file GoddamnEngine/Engine/Interface/Graphics/GraphicsDirect3D1x/GraphicsDirect3D1xFormatWIC.h
* File contains export interface for Direct3D 1x Implementation of the graphics interface: WIC format tables.
*/
#pragma once
...
GD_NAMESPACE_BEGIN
	...
	#if GD_IGRAPHICS_DIRECT3D1X_IMPL || GD_IGRAPHICS_DIRECT3D12_IMPL || GD_IGRAPHICS2D_DIRECT2D_IMPL
	WICPixelFormatGUID static const* IGraphicsDirect3D1xFormatsTableWIC[IGRAPHICS_FORMATS_COUNT] = {
		// ..Generic formats..
		// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	//! @returns The DXGI format that this format value represents.
	GDINL static REFWICPixelFormatGUID IGraphicsDirect3D1xFormatConvertWIC(IGraphicsFormat const gfxFormat)
	{
		return *IGraphicsDirect3D1xFormatsTableWIC[IGraphicsFormatGetIndex(gfxFormat)];
	}
#endif	// if GD_IGRAPHICS_DIRECT3D1X_IMPL || GD_IGRAPHICS_DIRECT3D12_IMPL || GD_IGRAPHICS2D_DIRECT2D_IMPL
