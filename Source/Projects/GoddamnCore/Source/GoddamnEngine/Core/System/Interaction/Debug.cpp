...
/*! 
 * @file GoddamnEngine/Core/System/Interaction/Debug.cpp
 ...
 */
	...
	{
		GD_DEBUG_ASSERT(Thread::GetCurrentThreadID() == Thread::GetMainThreadID(), "Creating output devices is allowed only inside main thread.");
