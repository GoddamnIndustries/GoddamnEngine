...
namespace GoddamnEngine.BuildSystem
{
    ...
    public class Solution : TargetCollector
    {
    ...
    public sealed class SolutionCache : TargetCollectorCache
    {
    ...
    public /*static*/ sealed class SolutionFactory : TargetCollectorFactory<Solution, SolutionCache>
    {
