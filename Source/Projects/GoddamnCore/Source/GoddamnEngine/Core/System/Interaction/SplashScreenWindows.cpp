...
/*!
 * @file GoddamnEngine/Core/System/Interaction/SplashScreenWindows.cpp
...
GD_NAMESPACE_BEGIN
	...
	GDAPI void SplashScreenWindows::OnInitialize()
	{
		...
		{	// Registering splash window class..
			...
			GD_ASSERT(result != 0, "'RegisterClass' function has failed.");
		}
		...
		{	// Loading fonts..
			...
			GD_ASSERT(splashDefaultFont != nullptr, "'GetStockObject(DEFAULT_GUI_FONT)' function has failed.");
		...
		{	// Creating window..
			...
			GD_ASSERT(m_SplashGuard != nullptr, "'CreateWindowEx' function has failed.");
			...
			GD_ASSERT(m_SplashWindow != nullptr, "'CreateWindowEx' function has failed.");
