...
/*! 
 * @file GoddamnEngine/Core/System/Misc/Endian.h
...
GD_NAMESPACE_BEGIN
	...
	{
		static_assert(sizeof TCastTo == sizeof TCastFrom, "Union casts's parameter should match sizes.");
	...
	{
		GD_DEBUG_ASSERT(size % sizeof *valuePtr == 0, "Incorrect size of data specified.");
