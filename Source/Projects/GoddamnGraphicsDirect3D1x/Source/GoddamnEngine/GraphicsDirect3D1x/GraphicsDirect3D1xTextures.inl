...
GD_NAMESPACE_BEGIN
	...
	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsDirect3D1xShaderResourceView);

	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	// Sampler state objects.
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsDirect3D1xSamplerState);
...
#define GD_IGRAPHICS_DIRECT3D1X_COMBINE_MINMAG_FILTERS(min, mag) ((min) | ((mag) << (8 * sizeof(mag))))
	...
	GDAPI IGraphicsDirect3D1xSamplerState::IGraphicsDirect3D1xSamplerState(IGraphicsSamplerStateCreationInfo const* const gfxSamplerStateCreationInfo)
		: IGraphicsSamplerState(gfxSamplerStateCreationInfo), D3DSamplerState(nullptr)
	{
		D3D1x_(SAMPLER_DESC) d3dSamplerState = {};
		...
		d3dSamplerState.AddressU = IGraphicsDirect3D1xTextureAddressModesTable[gfxSamplerStateCreationInfo->SamplerAddressModeU];
		d3dSamplerState.AddressV = IGraphicsDirect3D1xTextureAddressModesTable[gfxSamplerStateCreationInfo->SamplerAddressModeV];
		d3dSamplerState.AddressW = IGraphicsDirect3D1xTextureAddressModesTable[gfxSamplerStateCreationInfo->SamplerAddressModeW];
		...
		else
		{
			...
			d3dSamplerState.Filter = D3D1x_(FILTER_ANISOTROPIC);
	...
	GDAPI IGraphicsDirect3D1xSamplerState::~IGraphicsDirect3D1xSamplerState()
	{
	}
	...
	GDAPI IResult IGraphicsDirect3D1xWithSamplerStates::GfxImm_SamplerStateCreate(IGraphicsSamplerState** const gfxSamplerStatePtr
		, IGraphicsSamplerStateCreationInfo const* const gfxSamplerStateCreationInfo)
	{
		...
		*gfxSamplerStatePtr = GD_NEW(IGraphicsDirect3D1xSamplerState, gfxSamplerStateCreationInfo);
		return IResult::Ok;
	}
	...
	GDAPI IGraphicsDirect3D1xShaderResourceView::IGraphicsDirect3D1xShaderResourceView(IGraphicsResourceType const gfxResourceType)
	...
	GDAPI IGraphicsDirect3D1xShaderResourceView::~IGraphicsDirect3D1xShaderResourceView()
	{
	}
	...
	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsDirect3D1xTexture2D);
	...
	GDAPI IGraphicsDirect3D1xTexture2D::IGraphicsDirect3D1xTexture2D(IGraphicsTexture2DCreationInfo const* const gfxTexture2DCreationInfo
	...
	GDAPI IGraphicsDirect3D1xTexture2D::~IGraphicsDirect3D1xTexture2D()
	{
	}
	...
	GDAPI IGraphicsShaderResourceView const* IGraphicsDirect3D1xTexture2D::CPU_GetShaderResourceView() const
	{
	...
	//! @returns Non-negative value if the operation succeeded.
	GDAPI IResult IGraphicsDirect3D1xTexture2D::Imm_UpdateData(IGraphicsTexture2DData const* const gfxTexture2DData)
	{
		...
		for (GLuint glMipLevel = 0; glMipLevel < glMipLevelsCount; ++glMipLevel)
		{
			...
			{
				// Even if no initial data was specified, we need to provide pixel formats into the Direct3D1x.
				// Specifying null image information for all mipmap levels.
				glTexImage2D(GL_TEXTURE_2D, glMipLevel
					, IGraphicsDirect3D1xFormatConvert(gfxTexture2DCreationInfo.TexturePixelFormat)
					, glMipLevelWidth, glMipLevelHeight, 0
					, IGraphicsDirect3D1xFormatGetLayout(gfxTexture2DCreationInfo.TexturePixelFormat)
					, IGraphicsDirect3D1xFormatGetType(gfxTexture2DCreationInfo.TexturePixelFormat)
					, nullptr
					);
			}
			...
			else
			{
				...
				glCompressedTexImage2D(GL_TEXTURE_2D, glMipLevel
					, IGraphicsDirect3D1xTextureCompressionModesTable[gfxTexture2DCreationInfo.TextureCompressionMode]
	...
	//! @param gfxTexture2DInitialData Initial data for our texture.
	//! @returns Non-negative value if the operation succeeded.
	GDAPI IResult IGraphicsBaseDirect3D1x_WithTextures2D::GfxImm_Texture2DCreate(IGraphicsTexture2D** const gfxTexture2DPtr
		...
		, IGraphicsTexture2DData const* const gfxTexture2DInitialData)
	{
		...
		*gfxTexture2DPtr = GD_NEW(IGraphicsDirect3D1xTexture2D, gfxTexture2DCreationInfo, gfxTexture2DInitialData);
		return IResult::Ok;
	}
	...
	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsDirect3D1xTextureCube);
	...
	GDAPI IGraphicsDirect3D1xTextureCube::IGraphicsDirect3D1xTextureCube(IGraphicsTextureCubeCreationInfo const* const gfxTextureCubeCreationInfo
		...
		: IGraphicsTextureCube(gfxTextureCubeCreationInfo), GLTextureCubeID(0), GLShaderResourceView(nullptr)
	{
		...
		GLShaderResourceView = GD_NEW(IGraphicsDirect3D1xShaderResourceView, IGRAPHICS_RESOURCE_TYPE_TEXTURE_CUBE);
		GLShaderResourceView->GLShaderResourceID = GLTextureCubeID;
	}

	// ------------------------------------------------------------------------------------------
	//! Deletes current GPU Cube texture.
	GDAPI IGraphicsDirect3D1xTextureCube::~IGraphicsDirect3D1xTextureCube()
	{
	...
	//! Queries the shader resource for current resource.
	//! @returns Pointer to the shader resource view. Should be released manually.
	GDAPI IGraphicsShaderResourceView const* IGraphicsDirect3D1xTextureCube::CPU_GetShaderResourceView() const
	{
	...
	//! @returns Non-negative value if the operation succeeded.
	GDAPI IResult IGraphicsDirect3D1xTextureCube::Imm_UpdateData(IGraphicsTextureCubeData const* /*const*/ gfxTextureCubeData)
	{
			...
			for (GLuint glMipLevel = 0; glMipLevel < glMipLevelsCount; ++glMipLevel)
			{
				...
				if (gfxTextureCubeData->TexureCubeSides[glCubeMapSide].TextureData == nullptr)
				{
					...
					glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + glCubeMapSide, glMipLevel
						, IGraphicsDirect3D1xFormatConvert(gfxTextureCubeCreationInfo.TexturePixelFormat)
						, glMipLevelWidth, glMipLevelHeight, 0
						, IGraphicsDirect3D1xFormatGetLayout(gfxTextureCubeCreationInfo.TexturePixelFormat)
						, IGraphicsDirect3D1xFormatGetType(gfxTextureCubeCreationInfo.TexturePixelFormat)
						, nullptr
						);
				}
				...
				else
				{
					...
					glCompressedTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + glCubeMapSide, glMipLevel
						, IGraphicsDirect3D1xTextureCompressionModesTable[gfxTextureCubeCreationInfo.TextureCompressionMode]
						, glMipLevelWidth, glMipLevelHeight, 0, glMipLevelSize
						, static_cast<Byte const*>(gfxTextureCubeData->TexureCubeSides[glCubeMapSide].TextureData) + glMipLevelOffset
						);
					glMipLevelOffset += glMipLevelSize;
	...
	//! @param gfxTextureCubeInitialData Initial data for our texture.
	//! @returns Non-negative value if the operation succeeded.
	GDAPI IResult IGraphicsBaseDirect3D1x_WithTexturesCube::GfxImm_TextureCubeCreate(IGraphicsTextureCube** const gfxTextureCubePtr
		...
		, IGraphicsTextureCubeData const* const gfxTextureCubeInitialData)
	{
		...
		*gfxTextureCubePtr = GD_NEW(IGraphicsDirect3D1xTextureCube, gfxTextureCubeCreationInfo, gfxTextureCubeInitialData);
		return IResult::Ok;
	}
	...
	GD_IMPLEMENT_CLASS_INFORMATION_NOT_CONSTRUCTIBLE(IGraphicsDirect3D1xTexture3D);
