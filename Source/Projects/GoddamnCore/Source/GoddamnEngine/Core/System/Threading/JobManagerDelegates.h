...
/*!
 * @file GoddamnEngine/Core/System/Threading/JobManagerDelegates.h
 * @note This file should be never directly included, please consider using <GoddamnEngine/Core/System/Threading/JobManager.h> instead.
 * Template delegates wrappers for job Delegates.
 */
#pragma once
#if !defined(GD_INSIDE_JOBMANAGER_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Core/System/Threading/JobManager.h> instead.
