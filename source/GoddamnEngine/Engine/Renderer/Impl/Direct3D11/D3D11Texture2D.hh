...
GD_NAMESPACE_BEGIN
	...
	public:
		...
		GDINL virtual handle GetNativePointer() const { return self->Texture.GetPointer(); }
		GDINL ID3D11Texture2D*          GetTexture       () const { return self->Texture.GetPointer(); }
		GDINL ID3D11SamplerState*       GetSample        () const { return self->TextureSample.GetPointer(); }
		GDINL ID3D11ShaderResourceView* GetShaderResource() const { return self->TextureShaderResource.GetPointer(); }
