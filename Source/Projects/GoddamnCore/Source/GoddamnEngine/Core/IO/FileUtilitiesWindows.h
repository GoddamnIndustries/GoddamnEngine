...
/*! 
 * @file GoddamnEngine/Core/IO/FileUtilitiesWindows.h
 * File contains file and directory utilities Windows interface.
 */
#pragma once
#if !defined(GD_INSIDE_FILEUTILITIES_H)
#	error This file should be never directly included, please consider using <GoddamnEngine/Core/IO/FileUtilities.h> instead.
