...
/*! 
 * @file GoddamnEngine/Core/System/Threading/Atomics.h
...
#include GD_PLATFORM_API_INCLUDE(GoddamnEngine/Core/System/Threading, Atomics)
...
GD_NAMESPACE_BEGIN
	...
	template<typename TValue>
	using AtomicUniquePtr = AtomicValuePtr<UniquePtr<TValue volatile>>;

	template<typename TValue>
	using AtomicSharedPtr = AtomicValuePtr<SharedPtr<TValue volatile>>;
