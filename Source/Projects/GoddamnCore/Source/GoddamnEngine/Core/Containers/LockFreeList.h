...
GD_NAMESPACE_BEGIN
	...
	public:
		...
		typedef Iterator<IteratorTagConst  >   ConstIterator;
		typedef Iterator<IteratorTagMutable> Iterator;
		
		/// Reverse iterator type this container uses.
		typedef ReverseContainerIterator<Iterator> ReverseContainerIterator;
