...
/*! 
 * @file GoddamnEngine/Core/System/IO/Directory.h
...
GD_NAMESPACE_BEGIN
	...
	public:
		...
		{
			GD_DEBUG_ASSERT(directoryPath != nullptr, "Null pointer directory path specified.");
		}
...
#include GD_PLATFORM_INCLUDE(GoddamnEngine/Core/System/IO, Directory)
