...
#	error 'Not implemented.'
		...
		GDINL static Matrix4x4 GD_VECTORCALL Translate(Vector3Fast const Translation)
		{
			Matrix4x4 Result = {};
#if GD_SIMD_DIRECTX_MATH
...
#	error 'Not implemented.'
		...
		//! @param Rotation The rotation quaternion.
		//! @param Scale The scale vector.
		GDINL static Matrix4x4 GD_VECTORCALL Rotate(Quaternion const Rotation)
		{
			Matrix4x4 Result = {};
#if GD_SIMD_DIRECTX_MATH
...
#	error 'Not implemented.'
		...
		//! @param Rotation The rotation quaternion.
		//! @param Scale The scale vector.
		GDINL static Matrix4x4 GD_VECTORCALL RotateScale(Quaternion const Rotation, Vector3Fast const Scale)
		{
			Matrix4x4 Result = {};
#if GD_SIMD_DIRECTX_MATH
...
#	error 'Not implemented.'
		...
		//! @param Rotation The rotation quaternion.
		//! @param Scale The scale vector.
		GDINL static Matrix4x4 GD_VECTORCALL TranslateRotateScale(Vector4 const Translation
