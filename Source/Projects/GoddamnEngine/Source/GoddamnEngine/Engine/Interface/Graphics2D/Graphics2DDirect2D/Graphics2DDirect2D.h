...
/*!
 * @file GoddamnEngine/Engine/Interface/Graphics2D/Graphics2DDirect2D/GraphicsDirect2D.h
...
#if GD_IGRAPHICS2D_DIRECT2D_IMPL
#	define GD_IGRAPHICS2D_DIRECT2D object_cast<GD::IGraphics2DDirect2D*>(GD::Graphics2D.GetPointer())
#endif	// if GD_IGRAPHICS2D_DIRECT2D_IMPL

GD_NAMESPACE_END

#if GD_IGRAPHICS2D_DIRECT2D_IMPL
#	include <GoddamnEngine/Engine/Interface/Graphics2D/Graphics2DDirect2D/Grpahics2DDirect2DRenderer.inl>
#endif	// if GD_IGRAPHICS2D_DIRECT2D_IMPL
