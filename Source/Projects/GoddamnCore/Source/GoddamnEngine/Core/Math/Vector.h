...
GD_NAMESPACE_BEGIN
	...
	public:
		...
		//! Computes a normalized version of this vector.
		//! @returns A normalized version of this vector.
		GDINL Vector3Fast GD_VECTORCALL Inverse() const
		{
			return  *this / Vector3Fast(1.0f);
		}
	...
	public:
		...
		//! Computes a normalized version of this vector.
		//! @returns A normalized version of this vector.
		GDINL Vector4 GD_VECTORCALL Inverse() const
		{
			return  *this / Vector4(1.0f);
		}
		...
		GDINL bool operator!= (Vector4 const& other) const
		{
			return !(*this == other);
		}
		//! @}
